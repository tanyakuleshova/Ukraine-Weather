...
function createCityList(item) {
    ...
    691650, 690548, 706483, 706448, 706369, 710735, 710791, 710719];
...
function weatherDisplay(response){
    ...
    weather_image.style.backgroundImage = "url('icons/night_snow.png')";
        ...
        weather_image.style.backgroundImage = "url('icons/night_clear_sky.png')";
    }else if(weather.icon == '09n' || weather.icon == '10n'){
        weather_image.style.backgroundImage = "url('icons/night_rain.png')";
    }else if(weather.description == 'clear sky' || weather.icon == '01d'){
        weather_image.style.backgroundImage = "url('icons/clear_sky.png')";
    } else if(weather.description == 'broken clouds' || weather.description == 'overcast clouds'){
        weather_image.style.backgroundImage = "url('icons/broken_clouds.png')";
    } else if(weather.description == 'few clouds'){
        weather_image.style.backgroundImage = "url('icons/few_clouds.png')";
    } else if(weather.description == 'scattered clouds'){
        weather_image.style.backgroundImage = "url('icons/scattered_clouds.png')";
    } else if(weather.description == 'rain' || weather.icon == '10d'){
        weather_image.style.backgroundImage = "url('icons/rain.png')";
        ...
        weather_image.style.backgroundImage = "url('icons/thunderstorm.png')";
    } else if(weather.description == 'snow' || weather.icon == '13d'){
        weather_image.style.backgroundImage = "url('icons/snow.png')";
    } else if(weather.description == 'mist' || weather.icon == '50d'){
        weather_image.style.backgroundImage = "url('icons/mist.png')";
    } else if(weather.description == 'drizzle' || weather.icon == '09d'){
        weather_image.style.backgroundImage = "url('icons/drizzle.png')";
    }
